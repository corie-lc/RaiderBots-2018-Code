...
import org.usfirst.frc7674.RaiderBots.subsystems.Wrist;
...
public class Robot extends TimedRobot {
    ...
    public static Drivertrain drivertrain;
    ...
    public void teleopPeriodic() {
        Scheduler.getInstance().run();
        SmartDashboard.putNumber("collectorPosition", Robot.collector.getPosition());
        SmartDashboard.putNumber("elevatorPosition", Robot.elevator.getPosition());
        SmartDashboard.putNumber("rearLiftPosition", Robot.rearLift.getPosition());
    }
}
