...
public class FrontLiftElevator extends Command {
    ...
    protected void execute() {
        ...
        double currentVoltageElevator = new WPI_TalonSRX(10).getMotorOutputVoltage();
        System.out.println(currentVoltageElevator);
    }
